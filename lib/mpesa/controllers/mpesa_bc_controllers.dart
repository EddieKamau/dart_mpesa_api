...
import 'package:dart_mpesa_api/mpesa/modules/mpesa_modules.dart' show MpesaBcModule;
import 'package:dart_mpesa_api/mpesa/serializers/mpesa_serializers.dart' show MpesaCbSerializer;


class MpesaBcController extends ResourceController{
  ...
  Future<Response> create(
    ...
    MpesaCbSerializer mpesaCbSerializer) async{
      ...
      final MpesaBcModule _mpesaBcModule = MpesaBcModule(
      ...
      final Map<String, dynamic> _mpesaRes = await _mpesaBcModule.transact();
